...
- Building: [Marklog](https://marklog.xyz) —— Turn any GitHub repo into a blog
...
- Personal thoughts & reflections: [blog.jask.dev](https://blog.jask.dev)
...
- Onchain diary: [theonchaindiary.com](https://theonchaindiary.com)
